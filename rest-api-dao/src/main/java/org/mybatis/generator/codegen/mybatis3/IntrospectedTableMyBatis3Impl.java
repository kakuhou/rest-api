...
public class IntrospectedTableMyBatis3Impl extends IntrospectedTable {
	...
	public List<GeneratedJavaFile> getGeneratedJavaFiles() {
		...
		for (AbstractJavaGenerator javaGenerator : clientGenerators) {
			...
			for (CompilationUnit compilationUnit : compilationUnits) {
				GeneratedJavaFile gjf = new GeneratedJavaFile(compilationUnit,
						getTargetProject(context.getJavaClientGeneratorConfiguration()
								.getTargetProject()),
						context.getProperty(PropertyRegistry.CONTEXT_JAVA_FILE_ENCODING),
						context.getJavaFormatter());
				answer.add(gjf);
	...
	public List<GeneratedXmlFile> getGeneratedXmlFiles() {
		...
		if (xmlMapperGenerator != null) {
			...
			String mergeable = context.getProperty("mergeable");
			...
			GeneratedXmlFile gxf = new GeneratedXmlFile(document,
					...
					getTargetProject(context.getSqlMapGeneratorConfiguration().getTargetProject()),
	...
	private String getTargetProject(final String targetProject) {
